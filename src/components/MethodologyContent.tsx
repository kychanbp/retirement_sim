...
// ─── Full methodology content (17 sections) ──────────────────
  ...
  σ_monthly = σ_annual / √12`}
      ...
      <Section title="10. Success Criterion">
        <p>
          ...
          above zero for every month of the simulation (accumulation and drawdown).
        </p>
        <Formula>
      ...
      <Section title="12. Safe Spending Search">
        ...
        <p>
          The initial search range upper bound is the larger of 3&times; the
          entered spending or 3&times; a simple drawdown estimate (total
          wealth &divide; withdrawal months). If the success rate at this
          upper bound still meets the target, the bound is doubled repeatedly
          (up to 5 times) until it brackets the true safe spending level. The
          binary search then runs up to 20 iterations, converging to within
          $25/month precision, and rounds to the nearest $10.
        </p>
      </Section>
